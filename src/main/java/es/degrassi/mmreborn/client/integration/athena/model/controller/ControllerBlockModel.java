...
public class ControllerBlockModel implements MMRAthenaBlockModel {
  ...
  public ControllerBlockModel(ConnectedTextureMap materials, BiPredicate<BlockState, BlockState> connectTo,
  ...
  public static class Factory implements AthenaModelFactory {
    ...
    public Supplier<AthenaBlockModel> create(JsonObject json) {
      ...
      if (materials == null) {
        ...
        return () -> new ControllerBlockModel(finalMaterials, conditions, new AthenaModelAttributes(new TintProvider.Index(4), RenderType.CUTOUT));
      }
    }
