...
public class HatchBlockModel implements MMRAthenaBlockModel {
  ...
  public HatchBlockModel(ConnectedTextureMap materials, BiPredicate<BlockState, BlockState> connectTo,
                          AthenaModelAttributes attributes) {
  ...
  @Override
  public List<MMRAthenaQuad> getQuads(AppearanceAndTintGetter level, BlockState state,
                                   BlockPos pos, Direction direction, Void ignored) {
  ...
  public static class Factory implements AthenaModelFactory {
    ...
    public Supplier<AthenaBlockModel> create(JsonObject json) {
      ...
      if (materials == null) {
        ...
        return () -> new HatchBlockModel(finalMaterials, conditions, new AthenaModelAttributes(new TintProvider.Index(4), RenderType.CUTOUT));
      }
    }
