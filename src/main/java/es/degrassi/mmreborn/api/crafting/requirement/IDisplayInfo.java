...
/**
 * Used by the JEI integration to collect information about an {@link IRequirement}
...
public interface IDisplayInfo {
   ...
   * The {@link ClickAction} will give you the {@link DynamicMachine} handling this {@link MachineRecipe} and which mouse button was clicked. 0 = left, 1 = right, 2 = middle
  ...
  interface ClickAction {
     ...
     */
    void handleClick(DynamicMachine machine, MachineRecipe recipe, int mouseButton);
  }
