...
public enum RelativeSide {
  ...
  public static final NamedCodec<RelativeSide> CODEC = NamedCodec.enumCodec(RelativeSide.class);

  public Component getTranslationName() {
    return Component.translatable("mmr.side." + name().toLowerCase(Locale.ROOT));
  }
